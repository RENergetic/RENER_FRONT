...
import island_production_overview from "./island_production_overview.json";
...
const templates = [
  ...
  { name: "island_production_overview", template: JSON.stringify(island_production_overview) },
