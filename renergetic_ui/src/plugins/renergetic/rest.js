...
export var BASE_URL_BASE_API = process.env.VUE_APP_API_URL_BASE_API; //"http://localhost:7981";
...
export var BASE_URL_KUBEFLOW_API = "http://localhost:7986"; //process.env.VUE_APP_API_URL_KUBEFLOW_API; //"; // //;  // // //  //; //
