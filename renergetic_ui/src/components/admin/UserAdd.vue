...
<template>
    <Dialog :visible="visible" :style="{width: '450px'}" header="Add new user" :modal="true" @update:visible="cancelAdd" >
        <div class="p-fluid grid">
            ...
            <ToggleButton v-model="user.credentials[0].temporary" onLabel="Temporal Password" offLabel="Permanent Password" onIcon="pi pi-check" offIcon="pi pi-times"/>
        </div>
        <template #footer>
